...
export declare function compareBuffers(a: ArrayBufferView, b: ArrayBufferView): boolean;
/**
...
export declare class Utils {
     ...
     */
    static removeCycles(obj: Dictionary, meta: EntityMetadata, seen?: Set<unknown>): void;
