...
class Utils {
     ...
     */
    static dropUndefinedProperties(o, value) {
        if (Array.isArray(o)) {
            return o.forEach((item) => Utils.dropUndefinedProperties(item, value));
        }
        if (!Utils.isObject(o)) {
            return;
        }
    ...
    static processValue(obj, k, v, meta, seen, idx) {
     ...
     */
    static removeCycles(obj, meta, seen = new Set()) {
        seen.add(obj);
